...
const PIPELINE_PLAN = [
  ...
  { id: "B3", label: "Industry research - agent-driven web search", file: "forecaster/stages/b3_research.py",
    detail: "A scout proposes searches, sees what came back, and asks for what is missing. Retrieved text is written to disk so a quote against it can be verified." },
  { id: "B5", label: "Extract - metrics and guidance, quoted", file: "forecaster/stages/b5_extract.py",
    detail: "Every quote is string-matched against the document it was attributed to; failures are dropped and named." },
